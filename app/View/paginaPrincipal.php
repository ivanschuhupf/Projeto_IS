        ...
        <div>
                  ...
                  <div id="box-1" class="box">
                    ...
                    <div id="box-4" class="box">
                        ...
                        <div id="box-44" class="box2"><a class="link" href="index.php"><b>Processos <br>Eletronicos</b>
                        </a></div>
                    </div>

                    <div id="box-5" class="box">
                        <img class="modle" src="public/imagens/moodleMobile.png" alt="">
                        <div id="box-55" class="box2"><a class="link" href="index.php"><b>Moodle</b>
                        </a></div>
                    </div>
...
<div>
        <div class="caixa">
            ...
            O presente projeto tem como objetivo aplicar o conhecimento adquirido nos treinamentos aplicados.
            ...
            Como o projeto é em torno de algo já solidificado na upf (intranet), teremos que simular algumas etapas, como cadastro de alunos, cursos e demais.
            Os passos a serem seguidos serão:
            Layouts de Páginas =ok
            Responsividade: O site conterá responsividade para melhor acesso de dispositivos menores;=ok
